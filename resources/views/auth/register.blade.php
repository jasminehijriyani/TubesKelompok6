...
<head>
    ...
    <title>Daftar - Library E-Commerce</title>
    <style>
        body {
    ...
    <div class="register-container">
        ...
        <form id="registerForm" action="{{ route('register') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select id="role" name="role" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-size: 1rem;">
